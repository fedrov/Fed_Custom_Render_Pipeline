...
float GetOtherShadow(OtherShadowData other, ShadowData global, Surface surfaceWS)
{
	...
	float3 lightPlane = other.spotDirectionWS;//default to spot light
	...
	//store normal bias in w component, normal bias should be scaled by the distance to the light plane
	//We find the distance to the plane by taking the dot product of the surface-to-light vector and the spot direction
